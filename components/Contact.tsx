...
export default function Contact() {
  ...
  return (
    <section id="contact" className="w-full py-14 sm:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        {/* Left Column: Direct Info & Action Cards */}
        <div className="lg:col-span-5 flex flex-col justify-between">
          <div>
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-white tracking-tight leading-tight mb-2 sm:mb-3">
              Let&apos;s build something <span className="text-blue-400">intelligent.</span>
            </h2>
            <p className="text-xs sm:text-sm font-mono text-slate-400 mb-6 sm:mb-8 leading-relaxed">
            ...
            <div className="space-y-3">
              ...
              <div className="p-3.5 sm:p-4 rounded-xl bg-[#0b1018] border border-[#172233] hover:border-[#1e2e47] flex items-center justify-between transition-colors">
                ...
                <button
                  ...
                  className="min-w-[38px] min-h-[38px] flex items-center justify-center rounded-lg bg-[#070b12] hover:bg-[#0f1724] border border-[#172233] text-slate-400 hover:text-white transition-all shrink-0 ml-2"
              ...
              {/* Location Card */}
              <div className="p-3.5 sm:p-4 rounded-xl bg-[#0b1018] border border-[#172233] flex items-center gap-3">
          ...
          {/* Download Resume Button (44px touch height) */}
          <div className="mt-6 pt-5 sm:pt-6 border-t border-[#172233]">
            <a
              href={personalInfo.resumePath}
              download
              className="w-full min-h-[44px] flex items-center justify-center gap-2 py-3 px-5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-mono text-xs sm:text-sm font-semibold shadow-lg shadow-blue-950 transition-all active:scale-[0.98]"
            >
        ...
        <div className="lg:col-span-7">
          <motion.div
            ...
            className="p-5 sm:p-8 rounded-2xl bg-[#0b1018] border border-[#172233] shadow-xl"
          >
            <h3 className="text-sm sm:text-base font-bold text-white font-mono mb-1">
              Send a Direct Message
            </h3>
            <p className="text-xs font-mono text-slate-400 mb-5 sm:mb-6">
              Drop a note or opportunity — I usually reply within 24 hours.
            </p>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="space-y-3.5 sm:space-y-4">
                ...
                <button
                  type="submit"
                  className="w-full min-h-[44px] flex items-center justify-center gap-2 py-3 px-5 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-mono font-semibold text-xs sm:text-sm transition-all shadow-md shadow-blue-950 active:scale-[0.99]"
                >
